...
class Exp_Main(Exp_Basic):
    ...
    def _get_data(self, data_type):
        data_set, data_loader = data_provider(self.args, data_type)
    ...
    def train(self, setting):
        train_data, train_loader = self._get_data(data_type='train')
        vali_data, vali_loader = self._get_data(data_type='val')
        test_data, test_loader = self._get_data(data_type='test')
    ...
    def predict(self, setting, load=False):
        pred_data, pred_loader = self._get_data(data_type='pred')
